            ...
            <div class="card mb-4 mb-md-0">
              <div class="card-body">
                ...
                <div v-if="user.Personal!=null">
                  ...
                  <div class="row" v-if="user.Personal.CivilStatus === 'Matrimonio' ||  user.Personal.CivilStatus === 'Union Libre'">
                    <hr>
            ...
            <div class="card mb-4 mb-md-0">
              ...
              <div class="card-body" v-else>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <!--Json problem-->
                        <p class="mb-0" style="font-size: .77rem;">{{ JSON.parse(user.Family.Dependientes).Number }}</p>
                    </div>
                </div>
                ...
                <div  v-if="user.Labor != null">
                  <div class="row">
                    ...
                    <div class="row" v-if="user.Labor.FinancialObligations">
                        ...
                        <div class="col-sm-8">
                            <p class="mb-0" style="font-size: .77rem;">{{ JSON.parse(user.Labor.FinancialObligations).Status }}</p>
                        </div>
                    </div>
                    <div class="row" v-else>
                        <p class="mb-4" style="font-weight: bold; text-align: center;"> Obligaciones financieras </p>
              ...
              <div class="card-body" v-else>
                ...
                <div v-if="user.Hobbies.Literature">
                    <div v-if="JSON.parse(user.Hobbies.Literature).Status">
                        <p  class="mb-4" style="font-weight: bold; text-align: center; color: green;"> Literature </p>
                        <div style="text-align: center;">
                            <ul style="text-align: left; display: inline-block;">
                    ...
                    <p v-else class="mb-4" style="font-weight: bold; text-align: center; color: red;"> Literature </p>
                    <hr>
                </div>
                ...
                <div v-if="user.Hobbies.Foods">
                    <div v-if="JSON.parse(user.Hobbies.Foods).Status">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <p class="mb-0" style="font-size: .77rem;">{{ JSON.parse(user.Hobbies.Foods).FavoriteFood }}</p>
                            </div>   
                        </div> 
                    </div>
